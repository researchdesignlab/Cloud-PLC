...
#define __MODBUSMASTER_DEBUG_PIN_B__ 4
...
class ModbusMaster
{
  public:
    ...
    */
    ...
    uint8_t  writeSingleCoil(uint8_t ,uint16_t, uint16_t);
  ...
  private:
    ...
    static const uint8_t ku8MaxBufferSize                = 105;   ///< size of response/transmit buffers    
